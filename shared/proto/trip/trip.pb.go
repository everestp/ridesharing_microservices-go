...
func (x *Route) GetGeometries() []*Geometry {
	if x != nil {
		return x.Geometries
	}
	return nil
...
type RideFare struct {
	...
	TotalPriceInCents string                 `protobuf:"bytes,4,opt,name=totalPriceInCents,proto3" json:"totalPriceInCents,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_trip_proto_rawDesc = "" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"o\n" +
	"\x05Route\x12.\n" +
	"\n" +
	"geometries\x18\x01 \x03(\v2\x0e.trip.GeometryR\n" +
	"geometries\x12\x1a\n" +
	...
	"\x11totalPriceInCents\x18\x04 \x01(\tR\x11totalPriceInCents2Q\n" +
	"\vTripService\x12B\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	3, // 5: trip.Route.geometries:type_name -> trip.Geometry
